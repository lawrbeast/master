...
exports.run = async (bot, message, args) => {
    ...
    request(UR_L, function(err, resp, body) {
        ...
        var STAT = new Discord.RichEmbed()
            ...
            .setAuthor('CSGO Game Tracker', 'https://pbs.twimg.com/profile_images/634027535240679424/hsxWOUZ0_400x400.png')
            .setURL(UR_L)
            .setColor("#111111")
            ...
            .addField('Profile', args[0], true)
            .setThumbnail('https://pbs.twimg.com/profile_images/634027535240679424/hsxWOUZ0_400x400.png')
            .setFooter(`csgo.tracker.network`);
